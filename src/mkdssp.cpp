 ...
 * 
 */
void noTraj(string& input, io::filtering_stream<io::input>& in, po::variables_map& vm);
void withTraj(string& input, io::filtering_stream<io::input>& in, po::variables_map& vm,
              string dcdname);
